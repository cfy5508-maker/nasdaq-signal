"""
low_threshold_sweep.py
사용법: python low_threshold_sweep.py

동작: 거래량 수준의 "낮은 쪽(급감)" 임계값을 -20/-25/-30/-40/-50/-60/-70%로
      스윕하면서, "낮음+추세상승중"과 "낮음+추세하락중" 조합의 다음날
      승률/변동성이 어떻게 변하는지 확인한다. (높은 쪽 40%와 대칭 검증)
...
VOL_LOOKBACK_3M = 63
TREND_N = 3
THRESHOLDS = [-20, -25, -30, -40, -50, -60, -70]
